...
<div in:blur={{ delay: 500 }} out:blur class="container">
    <div class="text-center">
        <div in:scale={{ start: 2 }}>
            <h2 class="text-4xl"><i class="bi bi-info-circle-fill" /></h2>
        ...
        <div>
            ...
            <div transition:scale class="my-5">
                <i class="text-5xl bi bi-fan block spin" />
            ...
            <!-- {:then value}
                <div in:scale={{ start: 2, delay: 500 }}>
                    <p>
                        This is a simple fetching example using <code
                            class="bg-dark-500 bg-opacity-50 p-1"
                            >fetch API</code
                        >
                    </p>
                    <table
                        class="w-max mx-auto my-5 children:(border-b border-slate-600 last:!border-none)"
                    >
                        ...
                        {:else}
                            <tr>
                                <td colspan="2" class="text-center text-red-500"
                                    >Empty data</td
                                >
                            </tr>
                        {/each}
        ...
        <p>
            This file lives in <code class="bg-dark-500 bg-opacity-50 p-1"
                >resources/routes/about.svelte</code
